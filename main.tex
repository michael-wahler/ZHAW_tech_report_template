...
\thesistype{Project Report}             % Type of thesis (e.g. Master Thesis) \ttype
...
\supervisorA{Steve Jobs, Apple Inc.}       % Name of supervisor 1,               \supnameA
...
\department{School of Engineering} 
                                        % Department,                         \deptname
\institute{Institute of Applied Information Technology} 
                                        % Institute,                          \instname
...
\grouplink           {https://www.zhaw.ch/en/engineering/institutes-centres/init/software-engineering/} % \grplink
